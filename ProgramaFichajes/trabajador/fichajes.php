    ...
    <main class="w-full h-full flex">
        <section class="w-full h-screen bg-gray-200 overflow-hidden">
            <div id="fichajeEntrada" class="w-full h-full flex flex-col justify-center items-center">
                <p id="tipofichaje" class="text-xl font-bold text-gray-700 mb-5">Fichaje Entrada</p>
                <form id="formEntrada" class="max-w-md mx-auto">
            ...
            <div id="fichajeSalida" class="w-full h-full hidden flex-col justify-center items-center">
                <p id="tipofichaje" class="text-xl font-bold text-gray-700 mb-5">Fichaje Salida</p>
                <form id="formSalida" class="max-w-md mx-auto">
                    <div class="relative z-0 w-full mb-5 group">
                        <input type="text" name="dni" id="dniS"
                            class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                            placeholder=" " required />
            ...
            <div id="tardeEntrada" class="w-full h-full hidden flex-col justify-center items-center gap-5">
            ...
            <div id="salidaBien" class=" hidden flex-col justify-center items-center">
                ...
                <p class="text-medium font-medium text-gray-700" id="horaFichajeS"></p>
            </div>
        </section>
    </main>
    <script>
        ...
        $("#formEntrada").on("submit", function (e) {
            ...
            $.post("./fichajeEntrada.php", { dni: dni }, function (data) {
                ...
                } else if (datosEmpleado.fichadoHoy == true) {
        ...
        $("#formSalida").on("submit", function (e) {
            ...
            $.post("./fichajeSalida.php", { dni: dni }, function (data) {
                ...
                } else if (datosEmpleado.temprano == false) {
                    $("#fichajeSalida").css("display", "none");
                    $("#salidaBien").css("display", "flex");
                    $("#nombreTrabajadorS").html(datosEmpleado.nombre + " " + datosEmpleado.apellido);
                    $("#dniS").html(datosEmpleado.dni);
                    $("#horaFichajeS").html(datosEmpleado.horaFichaje);
