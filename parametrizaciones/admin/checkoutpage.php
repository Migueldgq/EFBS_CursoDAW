        ...
        <div class="w-full">
            <div class="-mx-3 md:flex items-start">
                <div class="px-3 md:w-7/12 lg:pr-10">
                    ...
                    $selectAllCarProducts = "SELECT * FROM detallecarrito WHERE car_id = $idCar";

                    $result = $conexion->query($selectAllCarProducts);

                    foreach ($result as $products) {
                      $productId = $products["product_id"];

                      $searchProductInfo = "SELECT * FROM productos WHERE product_id = $productId";

                      $productsResult = $conexion->query($searchProductInfo);
                      ...
                      <div class="product w-full mx-auto text-gray-800 font-light mb-6 border-b border-gray-200 pb-6">
                      <div class="w-full flex items-center">
                          <div class="overflow-hidden rounded-lg w-16 h-16 bg-gray-50 border border-gray-200">
                              <img src="../imagenes/product<?php
                                          echo $productId?>/<?php echo $productImg; ?>" alt="">
                          </div>
                          <div class="flex-grow pl-3">
                              <h6 class="font-semibold uppercase text-gray-600"><?php echo $productName  ?></h6>
                              <p class="text-gray-400">x 1</p>
                          </div>
                          <div>
                              <span class="font-semibold text-gray-600 text-xl"><?php  echo $productPrice    ?> €</span>
                          </div>
                      </div>
                  </div>
