...
<?php
  ...
  $id = $_SESSION["usuario-admin"];
    ...
    $searchLoggedAdminInfo = "SELECT * FROM administradores WHERE admin_id = $id ";

    $ejecutar = $conexion->query($searchLoggedAdminInfo);

    
      foreach ($ejecutar as $adminLoggedInfo) {
        $name = $adminLoggedInfo["admin_name"];
        $lastname = $adminLoggedInfo["admin_lastname"];
        
        $email = $adminLoggedInfo["admin_email"];
              ...
              <div class="hidden sm:ml-6 sm:block">
                <div class="flex space-x-4">
                  ...
                  if (isset($_SESSION["usuario-admin"])) {
                    ...
                    $searchLoggedUserInfo = "SELECT * FROM administradores WHERE admin_id = $id ";
