...
<html lang="en">
  ...
  if (isset($_SESSION["usuario-admin"])) {
        ...
        <div class="flex flex-wrap -mx-3 mb-6">
          <div class="w-full px-3">
            ...
            <input
              ...
              id="grid-email"
              type="text"
              placeholder="Por ejemplo: Movil usado"
              required
              name="nombre"
            />
          </div>
          <div class="w-full px-3">
            ...
            <input
              ...
              id="grid-password"
              type="text"
              placeholder="Por ejemplo: Poco uso"
              required
              name="descripcion"
          ...
          <div class="w-full px-3">
            ...
            <input
              ...
              required
              name="precio"
              placeholder="Introduce el precio aqui"
    ...
    ?>
    <h1>Estamos en productos y no eres admin ja ja ja ja</h1>
    <?php
  }?>
